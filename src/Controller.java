...
public class Controller {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.toLowerCase().compareTo("new task") == 0) {
                ...
                for (Task t : tasks) {
                    if (t.name.toLowerCase().compareTo(sinput) == 0) {
                        editTask(t);
                    }
                }
            }
    ...
    public static void editCourse(Course c) {
        ...
        while (true) {
            System.out.println("Enter the course component you want to edit: 'name', 'code', 'task', or 'semester'. Enter 'done' if you're done editing.");
            String st = scanner.nextLine();
    ...
    public static void editTask(Task t){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the course component you want to edit: 'name', 'type', 'associated course', or 'semester'. Enter 'done' if you're done editing.");
        String st = scanner.nextLine();
